...
class BARTDecoder(nn.Module):
    ...
    def __init__(
        self, decoder_layer: int, max_position_embeddings: int, name_or_path: Union[str, bytes, os.PathLike] = None, cache_dir: str = None
    ):
        super().__init__()
...
class DonutModel(PreTrainedModel):
    ...
    def json2token(self, obj: Any, update_special_tokens_for_json_key: bool = True, sort_json_key: bool = False):
        """
